...
describe('<Product />', () => {
  ...
  describe('Should toggle FullPoints component', () => {
    it('renders one <ProductPriceWrapper/> if fullPoints is FALSE', () => {
      const { product, _isFullPointsOnly } = minProps
      const ShallowedWrapper = mount(
        intl({
          component: (
            <ToggleFullPoints
              entity={product}
    ...
    it('renders one <FullPointsWrapper/> if fullPoints is TRUE', () => {
      const { product } = minProps
      const ShallowedWrapper = mount(
        intl({
          component: (
            <ToggleFullPoints
      ...
      expect(ShallowedWrapper.find(FullPointsWrapper)).toHaveLength(1)
    })
  })

  describe('Should toggle EarnPoints component', () => {
    it('renders one <PointsInfo/> if fullPoints is FALSE', () => {
      const ShallowedWrapper = mount(
        intl({
          component: (
            <ToggleEarnPoints
      ...
      expect(ShallowedWrapper.find(PointsInfo)).toHaveLength(1)
    })
    it('renders none <PointsInfo/> if fullPoints is TRUE', () => {
      const ShallowedWrapper = mount(
        intl({
          component: (
            <ToggleFullPoints
      ...
      expect(ShallowedWrapper.find(PointsInfo)).toHaveLength(0)
    })
  })
  ...
  it('renders three <CollapseContent/> styled component', () => {
    const ShallowedWrapper = shallow(<Product {...minProps} />)
    expect(ShallowedWrapper.find(CollapseContent)).toHaveLength(3)
  })
