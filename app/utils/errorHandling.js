...
export const COUPON_ERROR_MESSAGES = {
  '2018-07-11': {
    applied: `Oh nos! You've used that coupon before! We have other great deals on our site. VISIT NOW!`,
    default: `Hold up! That coupon code's been used! BUT WAIT! Visit our site now and get mind blown!`
  },
  '2018-07-12': {
    applied: `Heya, friend! That coupon's no longer valid! Use #711TY on our flash deals and get...a surprise!`,
  ...
  default: {
    applied: `Ahoy, mate! Sorry about that! Please visit our website for great deals while we fix the issue.`,
    default: `Ooops! That's embarrassing! Check out our website while we fix the issue.`
  }
}

// THIS IS TEMPORARY WHILE BACKEND CANT PROVIDE THE CODES YET!
export const TEMP_MESSAGE_PARSE_APPLIED = 'Coupon already applied on previous transaction'
...
export const sevenElevenCouponPromoErrorHandling = ({ code = 'default' }) => {
  ...
  const errMessageIdentifier = code.indexOf(TEMP_MESSAGE_PARSE_APPLIED) >= 0 ? 'applied' : 'default'

  return couponError[errMessageIdentifier]
}
